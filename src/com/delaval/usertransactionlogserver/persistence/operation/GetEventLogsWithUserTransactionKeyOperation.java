...
public class GetEventLogsWithUserTransactionKeyOperation implements ReadOperation {
    ...
    public void execute() {
        ...
        List<EventLog> resultList = new ArrayList<>();
        resultList.addAll(result);
        resultList.forEach(logContent -> all.add(new com.delaval.usertransactionlogserver.domain.InternalEventLog(logContent)));
        operationResult = all;
    }
